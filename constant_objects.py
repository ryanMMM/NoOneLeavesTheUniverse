...
def unpack_armor_into_objects():
    """unpacks armor attributes into objects within a dictionary"""

    armor_output_dictionary = {}

    for armor_key in armor_attribute_dictionary:
        armor_output_dictionary[armor_key] = {}
        helmet_attributes = armor_attribute_dictionary[armor_key]['helmet']
        chestplate_attributes = armor_attribute_dictionary[armor_key]['chestplate']
        boots_attributes = armor_attribute_dictionary[armor_key]['boots']
        armor_output_dictionary[armor_key]['helmet'] = Helmet(helmet_attributes['name'],
                                                              helmet_attributes['defense'],
                                                              helmet_attributes['armor_set'],
                                                              helmet_attributes['cost'])
        armor_output_dictionary[armor_key]['chestplate'] = Chestplate(chestplate_attributes['name'],
                                                                      chestplate_attributes['defense'],
                                                                      chestplate_attributes['armor_set'],
                                                                      chestplate_attributes['cost'])
        armor_output_dictionary[armor_key]['boots'] = Boots(boots_attributes['name'],
                                                            boots_attributes['defense'],
                                                            boots_attributes['armor_set'],
                                                            boots_attributes['cost'])

    return armor_output_dictionary
...
armor_object_dictionary = unpack_armor_into_objects()
